          ...
          >
            ...
            {!isMobile && (
              ...
              >
                ...
                <span className="font-display text-4xl tracking-[0.35em] text-foreground">SAMBI TOP GEAR</span>
            ...
            {/* Mobile logo — stacked, portrait-friendly */}
            {isMobile && (
              <motion.div
                className="relative flex flex-col items-center leading-none select-none"
                animate={{ opacity: [0, 0, 1, 1, 0, 0], scale: [0.92, 0.92, 1, 1, 1.04, 1.04] }}
              ...
              >
                ...
                <span className="font-display text-5xl tracking-[0.2em] text-foreground">SAMBI</span>
                <span className="font-display text-2xl tracking-[0.25em] text-foreground/70 mt-1">TOP GEAR</span>
                <span className="text-[9px] tracking-[0.4em] text-primary font-semibold mt-3">MOTORS · LIMASSOL</span>
                <div className="w-6 h-px bg-primary mt-4" />
              </motion.div>
            )}
          </motion.div>
        ) : null}
