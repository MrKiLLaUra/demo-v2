  ...
  if (sent) {
    return (
      <div className="border border-border bg-card p-8 md:p-10 text-center">
        ...
        <h3 className="font-display text-2xl tracking-wide mb-2">MESSAGE RECEIVED</h3>
  ...
  return (
    <form onSubmit={handleSubmit} className="border border-border bg-card p-6 md:p-8 space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div>
          <label className="text-[9px] tracking-[0.2em] text-muted-foreground/60 block mb-1.5">SUBJECT</label>
          <input
            type="text"
            placeholder="Enquiry about a car"
            value={form.subject}
