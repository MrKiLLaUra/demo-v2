  ...
  return (
    <div>
      ...
      <section className="border-b border-border/50 py-16 md:py-20 px-6 text-center">
        <div className="text-xs tracking-[0.3em] text-primary mb-4 font-semibold">GET IN TOUCH</div>
        <h1 className="font-display text-5xl md:text-6xl tracking-wide mb-4">CONTACT US</h1>
        ...
        <div>
          ...
          {contactInfo.map(item => (
            ...
            >
              ...
              <div>
                <div className="text-[10px] text-muted-foreground tracking-widest mb-1">{item.label.toUpperCase()}</div>
                <div className="text-foreground/80">{item.value}</div>
              </div>
            </div>
          ))}

          <div className="border border-border p-5 bg-primary/[0.02] relative mt-8">
