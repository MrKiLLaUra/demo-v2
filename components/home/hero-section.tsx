          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            ...
            <div ref={ctaRef} className="flex flex-col sm:flex-row gap-3 lg:shrink-0">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 border border-foreground/20 hover:border-foreground/50 px-8 py-4 font-display text-lg tracking-[0.15em] transition-colors"
              >
                CONTACT US
              </a>
            </div>
